...
class TestTicketsAPIView:
    ...
    def test_get_invalid_start_limit(self, factory, auth_user):
        request = factory.get(
    ...
    def test_get_non_int_start_limit_use_default(self, factory, auth_user, real_project):
    ...
    def test_get_internal_server_error(self, factory, auth_user, real_project):
        project = real_project
        request = factory.get(f"/api/v1/projects/{project.uuid}/tickets/", {'view_id': 'v1'})
        request.user = auth_user
        with patch('seahub.utils.decorators.is_org_context', return_value=True), \
    ...
    def test_post_assignees_invalid_json(self, factory, auth_user):
        data = {
            'title': 't',
    ...
    def test_post_creation_interval_too_frequent(self, factory, auth_user, real_project):
        project = real_project
        data = {'title': 't', 'content': json.dumps({'text': 'c'})}
        request = factory.post(f"/api/v1/projects/{project.uuid}/tickets/", data=data)
        request.user = auth_user
    ...
    # PUT
    def test_put_missing_data(self, factory, auth_user):
    ...
    def test_put_row_id_invalid(self, factory, auth_user, real_project):
        project = real_project
    ...
    def test_put_invalid_content(self, factory, auth_user, real_project):
        project = real_project
    ...
    def test_put_success_update_state_closed(self, factory, auth_user, real_project):
        project = real_project
    ...
    # DELETE
    def test_delete_missing_ticket_ids(self, factory, auth_user):
    ...
    def test_delete_partial_success(self, factory, auth_user, real_project):
        project = real_project
        data = {'ticket_ids': ['1', '2']}
...
class TestTicketAPIView:
    def test_get_ticket_not_found(self, factory, auth_user, real_project):
        project = real_project
    ...
    def test_put_ticket_not_found(self, factory, auth_user, real_project):
        project = real_project
    ...
    def test_put_priority_invalid(self, factory, auth_user, real_project):
        project = real_project
    ...
    def test_put_success_state_closed_and_participants(self, factory, auth_user, real_project):
        project = real_project
        ...
        assert auth_user.username in update_row['participants']
        assert update_row['priority'] == 5

    def test_delete_ticket_not_found(self, factory, auth_user, real_project):
        project = real_project
...
class TestMyTicketAPIView:
    ...
    def test_post_success(self, factory, auth_user, real_project):
        ...
        with patch('seahub.utils.decorators.is_org_context', return_value=True), \
            ...
            resp = MyTicketAPIView.as_view()(request, project_uuid=str(project.uuid))
        assert resp.status_code == 200
        assert 'tickets' in resp.data
...
class TestTicketTrashAPIView:
    ...
    def test_delete_no_deleted_tickets(self, factory, auth_user, real_project):
        project = real_project
...
class TestTicketCommentsAPIView:
    ...
    def test_get_invalid_pagination_use_default(self, factory, auth_user, real_project):
        project = real_project
...
class TestTicketCommentAPIView:
    ...
    def test_put_too_frequent(self, factory, auth_user, real_project):
        project = real_project
        data = {'content': json.dumps({'text': 'hi'})}
        request = factory.put(f"/api/v1/projects/{project.uuid}/tickets/1/comments/1/", data=data, format='json')
        request.user = auth_user
    ...
    def test_delete_feature_not_enabled(self, factory, auth_user):
