...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('/api/v1/project/{project_uuid}/agent/logs/', 'api-v1-project-agent-logs'),
        ('/api/v1/project/{project_uuid}/agent/log/runs/', 'api-v1-project-agent-log-runs'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        '/api/v1/project/{project_uuid}/agent/logs/',
        '/api/v1/project/{project_uuid}/agent/log/runs/',
