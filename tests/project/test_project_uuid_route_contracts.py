...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('/api/v1/project/{project_uuid}/agent/items/', 'api-v1-project-agent-items'),
        ('/api/v1/project/{project_uuid}/agent/item/runs/', 'api-v1-project-agent-item-runs'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        '/api/v1/project/{project_uuid}/agent/items/',
        '/api/v1/project/{project_uuid}/agent/item/runs/',
