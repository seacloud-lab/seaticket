...
class TestKnowledgeBaseViewsGet:
    ...
    def test_get_internal_error_returns_500(
        self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted
    ):
    ...
    def test_get_success_returns_views(
        self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted, mock_list_views
    ):
        url = get_kb_views_url(project_uuid)
...
class TestKnowledgeBaseViewsPost:
    def test_post_missing_name_returns_400(self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted):
        url = get_kb_views_url(project_uuid)
        data = {'type': 'table'}
    ...
    def test_post_success_returns_view(
        self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted,
        mock_get_record_views, mock_add_view
    ):
        url = get_kb_views_url(project_uuid)
        data = {'name': 'New view'}
...
class TestKnowledgeBaseViewDetailGet:
    ...
    def test_get_record_missing_returns_404(
        self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted, mock_get_record_views_none
    ):
...
class TestKnowledgeBaseViewDetailPut:
    def test_put_missing_data_returns_400(self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted):
        url = get_kb_view_url(project_uuid, '0000')
...
class TestKnowledgeBaseViewsDuplicate:
    def test_duplicate_missing_view_id_returns_400(self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted):
...
class TestKnowledgeBaseViewsMove:
    def test_move_missing_source_returns_400(self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted):
    ...
    def test_move_missing_target_returns_400(self, api_client, project_uuid, mock_get_project_by_uuid, mock_check_permission_granted):
        url = get_kb_move_views_url(project_uuid)
