...
class TokenViewTest(BaseTestCase):
    ...
    @patch('seahub.invitations.views.user_number_over_limit')
    def test_post(self, mock_user_number_over_limit):
    ...
    @patch('seahub.invitations.views.user_number_over_limit')
    def test_can_notify_inviter(self, mock_user_number_over_limit):
        mock_user_number_over_limit.return_value = False
