...
from seahub.avatar.settings import (AVATAR_STORAGE_DIR, AVATAR_RESIZE_METHOD, AVATAR_THUMB_FORMAT,
...
class AvatarBase(object):
    ...
    def create_thumbnail(self, size, quality=None):
        ...
        try:
            ...
            logger.warning(e)
            try:
                self.delete()  # image error, delete image file
            except:
                pass
            return
...
class Avatar(models.Model, AvatarBase):
    emailuser = LowerCaseCharField(max_length=255, db_index=True)
