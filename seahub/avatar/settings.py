...
AVATAR_DEFAULT_NON_REGISTERED_URL = getattr(settings, 'AVATAR_DEFAULT_NON_REGISTERED_URL', '/avatars/default.png')
APP_AVATAR_DEFAULT_URL = getattr(settings, 'APP_AVATAR_DEFAULT_URL', 'avatar/img/app.png')
...
AVATAR_CACHE_TIMEOUT = getattr(settings, 'AVATAR_CACHE_TIMEOUT', 24 * 60 * 60)
