...
urlpatterns = [
    ...
    re_path(r'^sys/users/(?P<email>[^/]+)/projects/$', sysadmin_react_fake_view, name="sys_user_dtables"),
    re_path(r'^sys/search-users/$', sysadmin_react_fake_view, name="sys_search_users"),
    re_path(r'^sys/search-projects/$', sysadmin_react_fake_view, name="sys_search_dtables"),
    re_path(r'^sys/all-projects/$', sysadmin_react_fake_view, name="sys_all_dtables"),
    ...
    re_path(r'^sys/organizations/(?P<org_id>\d+)/projects/$', sysadmin_react_fake_view, name="sys_organization_dtables"),
    ...
    re_path(r'^sys/groups/(?P<group_id>\d+)/projects/$', sysadmin_react_fake_view, name="sys_group_dtables"),
