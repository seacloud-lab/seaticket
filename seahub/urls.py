...
from seahub.api2.endpoints.notifications import NotificationsView, NotificationView, NotificationsAllView, \
    ProjectNotificationsView, ProjectNotificationView, ProjectTicketNotificationsView
...
urlpatterns = [
    ...
    re_path(r'^api/v1/projects/(?P<project_uuid>[0-9a-f\-]{36})/notifications/ticket/(?P<ticket_id>\d+)/$', ProjectTicketNotificationsView.as_view(), name='api-v2.1-project-notifications-ticket'),
    ...
    re_path(r'^', include('seahub.skills.urls')),
