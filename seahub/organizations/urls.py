...
urlpatterns = [
    ...
    re_path(r'^search-projects/$', react_fake_view, name='org_admin_search_dtables'),
    ...
    re_path(r'^groupadmin/(?P<group_id>\d+)/projects/$', react_fake_view, name='org_admin_group_dtables'),
