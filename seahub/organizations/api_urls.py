...
from seahub.api2.endpoints.org_admin.statistics import OrgAdminAIStatisticsView, OrgAdminAIStatisticsDetailView, \
    OrgAdminAIStatisticsOverviewView
...
urlpatterns = [
    ...
    re_path(r'^(?P<org_id>\d+)/admin/trash-projects/$', OrgAdminTrashProjectsView.as_view(), name='api-v1-org-admin-trash-projects'),
    re_path(r'^(?P<org_id>\d+)/admin/trash-projects/(?P<project_id>\d+)/$', OrgAdminTrashProjectView.as_view(), name='api-v1-org-admin-trash-project'),
    re_path(r'^(?P<org_id>\d+)/admin/search-projects/$', OrgAdminSearchProjectsView.as_view(), name='api-v1-org-admin-search-projects'),

    re_path(r'^(?P<org_id>\d+)/admin/users/$', OrgAdminUsers.as_view(), name='api-v1-org-admin-users'),
    re_path(r'^(?P<org_id>\d+)/admin/invite-users/$', OrgAdminInviteUsers.as_view(), name='api-v1-org-admin-invite-users'),
    ...
    re_path(r'^(?P<org_id>\d+)/admin/saml-config/$', OrgSAMLConfigView.as_view(), name='api-v1-org-admin-saml-config'),
    re_path(r'^(?P<org_id>\d+)/admin/verify-domain/$', OrgVerifyDomain.as_view(), name='api-v1-org-admin-verify-domain'),

    # AI statistics
    re_path(r'^(?P<org_id>\d+)/admin/statistics/ai/$', OrgAdminAIStatisticsView.as_view(), name='api-v1-org-admin-ai-statistics'),
    re_path(r'^(?P<org_id>\d+)/admin/statistics/ai/detail/$', OrgAdminAIStatisticsDetailView.as_view(), name='api-v1-org-admin-ai-statistics-detail'),
    re_path(r'^(?P<org_id>\d+)/admin/statistics/ai/overview/$', OrgAdminAIStatisticsOverviewView.as_view(), name='api-v1-org-admin-ai-statistics-overview'),
]
