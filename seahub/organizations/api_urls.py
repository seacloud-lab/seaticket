...
from seahub.api2.endpoints.org_admin.statistics import OrgAdminAIStatisticsView, OrgAdminAIStatisticsModelsView, OrgAdminAIStatisticsDetailView
...
urlpatterns = [
    ...
    re_path(r'^(?P<org_id>\d+)/admin/statistics/ai/models/$', OrgAdminAIStatisticsModelsView.as_view(), name='api-v1-org-admin-ai-statistics-models'),
