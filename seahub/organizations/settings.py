...
FREE_ORG_DEPARTMENT_OR_GROUP_LIMIT = getattr(settings, 'FREE_ORG_DEPARTMENT_OR_GROUP_LIMIT', 100)

ADVANCE_ORG_DEPARTMENT_OR_GROUP_LIMIT = getattr(settings, 'ADVANCE_ORG_DEPARTMENT_OR_GROUP_LIMIT', 1000)

FREE_ORG_BASE_LIMIT = getattr(settings, 'FREE_ORG_BASE_LIMIT', 500)
