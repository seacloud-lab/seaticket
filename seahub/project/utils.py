...
def create_connection(project, username, connection_type, name, config):
    ...
    init_table_funcs = {
        ...
        ConnectionType.FIREBASE_CRASH.value: lambda api, project_uuid, connection_id: init_seadb_tables_from_schema(
            [SchemaTables.FIREBASE_CRASH_ISSUES], api, project_uuid, connection_id
        ),
    }
