...
from .views import project_view, github_install, github_installation_setup, linear_oauth, linear_oauth_callback, \
    ...
    email_oauth, email_oauth_callback, notion_oauth, notion_oauth_callback
...
from .connections import ProjectConnectionsView, ProjectConnectionView, ProjectConnectionSyncView, \
    ...
    DownloadEmailAttachments, ZipEmailAttachments, QueryIOStatus, ProjectLinearOauthStatusView, ProjectConfluenceOauthStatusView, ProjectConnectionUnreadEmailView, ProjectJiraOauthStatusView, ProjectNotionOauthStatusView
...
urlpatterns = [
    ...
    re_path(r'^notion/oauth/$', notion_oauth, name='project_notion_oauth'),
    re_path(r'^notion/oauth/callback/$', notion_oauth_callback, name='project_notion_oauth_callback'),
    ...
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/notion-oauth/$', ProjectNotionOauthStatusView.as_view(), name='api-v1-project-notion-oauth-status'),
