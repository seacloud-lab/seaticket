...
from .connections import ProjectConnectionsView, ProjectConnectionView, ProjectConnectionSyncView, \
    ...
    ProjectConnectionsStatusView, ProjectConnectionLogView, ProjectConnectionRecordView, ProjectConnectionRecordsView, \
     ProjectConnectionReplyEmailView, ProjectConnectionCalendarReplyView, ProjectConnectionDeleteEmailView, ProjectConnectionReplyDiscourseView, \
...
urlpatterns = [
    ...
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/connections/(?P<connection_id>\d+)/calendar-reply/$', ProjectConnectionCalendarReplyView.as_view(), name='api-v1-connection-calendar-reply'),
