...
from .connections import ProjectConnectionsView, ProjectConnectionView, ProjectConnectionSyncView, \
    ...
    ProjectConnectionReplyEmailView, ConnectionFileView, GithubIssueEditorView
...
urlpatterns = [
    ...
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/connections/(?P<connection_id>\d+)/github-issue-editor/$', GithubIssueEditorView.as_view(), name='api-v1-connection-github-issue-editor'),
