...
TICKET_DISPLAY_ALL_COLUMNS = ['_pk', 'title', 'content', 'ai_summary', 'ai_processed_time', 'state', 'substate', 'type', 'tags', 'assignees', 'participants', 'priority', 'creator', 'created_time', 'modified_time', 'closed_time']
CONNECTION_DISPLAY_ALL_COLUMNS = {
    ...
    ConnectionType.EMAIL.value: ['_pk', 'title', 'modified_time', 'unread', 'ai_summary', 'ai_processed_time']
}
...
KNOWLEDGE_BASE_DISPLAY_ALL_COLUMNS = ['_pk', 'title', 'content', 'tags', 'ai_summary', 'ai_processed_time', 'creator', 'created_time', 'last_modifier', 'modified_time']
KNOWLEDGE_BASE_EXPORT_DISPLAY_ALL_COLUMNS = ['title', 'content', 'creator', 'created_time', 'last_modifier', 'modified_time']
