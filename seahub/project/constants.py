...
CONNECTION_DISPLAY_ALL_COLUMNS = {
    ...
    ConnectionType.JIRA_ISSUE.value: ['_pk', 'issue_key', 'title', 'content', 'author', 'status', 'priority', 'issue_type',
    ...
    ConnectionType.EMAIL.value: ['_pk', 'title', 'modified_time', 'unread', 'is_replied', 'ai_summary', 'ai_processed_time', 'linked_ticket', 'outdated', 'tags'],
...
KNOWLEDGE_BASE_DISPLAY_ALL_COLUMNS = ['_pk', 'title', 'tags', 'ai_summary', 'ai_processed_time', 'creator', 'created_time', 'last_modifier', 'modified_time', 'featured_articles']
...
NOTIFICATION_JWT_TOKEN_EXPIRATION_TIME = 10 * 60

REF_URL_CONNECTION_CACHE_PREFIX = 'REF_URL_CONNECTION_'
REF_URL_CONNECTION_CACHE_TIMEOUT = 60 * 60
