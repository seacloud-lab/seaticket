...
CONNECTION_DISPLAY_ALL_COLUMNS = {
    ...
    ConnectionType.GENERAL_TASK.value: ['_pk', 'title', 'status', 'size', 'priority', 'assignees', 'due_date', 'modified_time', 'created_time', 'ai_summary', 'ai_processed_time', 'linked_ticket', 'outdated']
}
