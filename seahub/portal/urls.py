...
urlpatterns = [
    ...
    re_path(r'^api/v1/portal/(?P<project_uuid>[-0-9a-f]{36})/external-sso-providers/(?P<provider_key>[a-z0-9]+(?:-[a-z0-9]+)*)/$', PortalExternalSSOProviderView.as_view(), name='api-v1-portal-external-sso-provider'),
    re_path(r'^api/v1/portal/(?P<project_uuid>[-0-9a-f]{36})/external-sso-providers/(?P<provider_key>[a-z0-9]+(?:-[a-z0-9]+)*)/reset-secret/$', PortalExternalSSOProviderResetSecretView.as_view(), name='api-v1-portal-external-sso-provider-reset-secret'),
