...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, email, name, password,
                             site, send_email=True):

        return self.create_email_user(username, email, name, password, site,
                                      send_email, is_active=False)
    # create_inactive_user = transaction.commit_on_success(create_inactive_user)

    def create_active_user(self, username, email, name, password,
                           site, send_email=True):
