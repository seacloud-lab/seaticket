...
ADDITIONAL_CREDITS_REDIS_CHANNEL = 'billing_ai_credits'
...
ADDITIONAL_CREDITS_REDIS_CHANNEL = configs.get('ADDITIONAL_CREDITS_REDIS_CHANNEL', ADDITIONAL_CREDITS_REDIS_CHANNEL)
...
BILLING_SERVICE_JWT_ALGORITHM = configs.get('BILLING_SERVICE_JWT_ALGORITHM', '')
BILLING_SERVICE_JWT_EXPIRATION = configs.get('BILLING_SERVICE_JWT_EXPIRATION')
