...
ISSUE_ATTACHMENT_MAX_COMMENTS = 50
...
GITHUB_APP_NAME = configs.get('GITHUB_APP_NAME')
GITHUB_WEBHOOK_SECRET = configs.get('GITHUB_WEBHOOK_SECRET')
...
ATTACHMENT_CONTENT_MAX_SIZE = configs.get('ATTACHMENT_CONTENT_MAX_SIZE') or configs.get('SEARCH_TOOL_CONTENT_MAX_SIZE') or ATTACHMENT_CONTENT_MAX_SIZE
ISSUE_ATTACHMENT_MAX_COMMENTS = configs.get('ISSUE_ATTACHMENT_MAX_COMMENTS') or configs.get('SEARCH_TOOL_ISSUES_MAX_COMMENTS') or ISSUE_ATTACHMENT_MAX_COMMENTS
