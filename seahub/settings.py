...
CONFLUENCE_CLIENT_ID = configs.get('CONFLUENCE_CLIENT_ID', '')
CONFLUENCE_CLIENT_SECRET = configs.get('CONFLUENCE_CLIENT_SECRET', '')
CONFLUENCE_REDIRECT_URL = configs.get('CONFLUENCE_REDIRECT_URL', '')
...
ROLE_PERMISSIONS = configs.get('ROLE_PERMISSIONS', {})
...
BILLING_REDIS_CONFIG = configs.get('BILLING_REDIS_CONFIG', {})
BILLING_AUTH_TOKEN = configs.get('BILLING_AUTH_TOKEN','')
BILLING_SERVICE_URL = configs.get('BILLING_SERVICE_URL', '')
BILLING_SERVICE_JWT_AUTH_URL = configs.get('BILLING_SERVICE_JWT_AUTH_URL', '')
BILLING_SERVICE_JWT_SECRET_KEY = configs.get('BILLING_SERVICE_JWT_SECRET_KEY', '')
BILLING_SERVICE_JWT_ALGORITHM = 'HS256'
BILLING_SERVICE_JWT_EXPIRATION = 5*60

LINEAR_CLIENT_ID = configs.get('LINEAR_CLIENT_ID', '')
LINEAR_CLIENT_SECRET = configs.get('LINEAR_CLIENT_SECRET', '')
LINEAR_REDIRECT_URL = configs.get('LINEAR_REDIRECT_URL', '')

DISCORD_CLIENT_ID = configs.get('DISCORD_CLIENT_ID', '')
DISCORD_CLIENT_SECRET = configs.get('DISCORD_CLIENT_SECRET', '')
...
FIREBASE_CRASH_CLIENT_ID = configs.get('FIREBASE_CRASH_CLIENT_ID', '')
FIREBASE_CRASH_CLIENT_SECRET = configs.get('FIREBASE_CRASH_CLIENT_SECRET', '')
FIREBASE_CRASH_REDIRECT_URL = configs.get('FIREBASE_CRASH_REDIRECT_URL', '')
