...
SEAQA_SEATABLE_CONNECTOR_INNER_SERVER_URL = 'http://seaqa-seatable-connector:8891'
...
SEAQA_SEATABLE_CONNECTOR_INNER_SERVER_URL = configs.get('SEAQA_SEATABLE_CONNECTOR_INNER_SERVER_URL', SEAQA_SEATABLE_CONNECTOR_INNER_SERVER_URL)
