...
def load_env_config():
    ...
    appconfig.seafile_conf_path = ""
    if appconfig.central_confdir:
        appconfig.seafile_conf_path = os.path.join(appconfig.central_confdir, 'seafile.conf')
    elif 'SEAFILE_CONF_DIR' in os.environ:
        appconfig.seafile_conf_path = os.path.join(os.environ['SEAFILE_CONF_DIR'], 'seafile.conf')
