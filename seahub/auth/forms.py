    ...
    def clean(self):
        ...
        if username and password:
            ...
            if self.user_cache is None:
                ...
                # convert login id or contact email or phone number to username if any
            ...
            oauth_provider_identifier = getattr(settings, 'OAUTH_PROVIDER_DOMAIN', 'oauth')
...
class PasswordResetForm(forms.Form):
    ...
    def save(self, domain_override=None, email_template_name='registration/password_reset_email.html',
        ...
        user.nickname = email2nickname(user.username)
...
class SetPasswordForm(forms.Form):
    ...
    """
    new_password1 = forms.CharField(label=_("New password"), max_length=4096, widget=forms.PasswordInput)
    new_password2 = forms.CharField(label=_("New password confirmation"), max_length=4096, widget=forms.PasswordInput)
...
class PasswordChangeForm(SetPasswordForm):
    ...
    their old password.
    """
    old_password = forms.CharField(label=_("Old password"), max_length=4096, widget=forms.PasswordInput)
