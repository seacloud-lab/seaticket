...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/project/(?P<project_uuid>[-0-9a-f]+)/tickets/(?P<ticket_id>\d+)/comments/(?P<reply_id>\d+)/$', TicketCommentAPIView.as_view(), name='api-v2.1-project-ticket-reply'),
