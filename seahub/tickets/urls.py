...
urlpatterns = [
    ...
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/tickets/(?P<ticket_id>\d+)/activities/$', TicketActivitiesAPIView.as_view(), name='api-v1-project-ticket-activities'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/tickets/search/$', TicketsSearchAPIView.as_view(), name='api-v1-project-tickets-search'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/tickets/trash/$', TicketTrashAPIView.as_view(), name='api-v1-project-tickets-trash'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/my-tickets/$', MyTicketAPIView.as_view(), name='api-v1-project-my-tickets'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket/metadata/$', TicketMetadataAPIView.as_view(), name='api-v1-project-ticket-metadata'),

    # types
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket/types/$', TicketTypesAPIView.as_view(), name='api-v1-project-types'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket/types/(?P<type_id>[-0-9a-zA-Z]{4})/$', TicketTypeAPIView.as_view(), name='api-v1-project-type'),

    # substates
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket/substates/$', TicketSubstatesAPIView.as_view(), name='api-v1-project-substates'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket/substates/(?P<substate_id>[-0-9a-zA-Z]{4})/$', TicketSubstateAPIView.as_view(), name='api-v1-project-substate'),

    # ticket views
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket-folders/$', TicketFolders.as_view(), name='api-v1-project-ticket-folders'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket-views/$', TicketViewsAPI.as_view(), name='api-v1-project-ticket-views'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket-views/(?P<view_id>.+)/$', TicketViewView.as_view(), name='api-v1-project-ticket-view'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket-move-views/$', TicketViewsMoveView.as_view(), name='api-v1-project-ticket-views-move'),
    re_path(r'^api/v1/project/(?P<project_uuid>[-0-9a-f]{36})/ticket-duplicate-view/$', TicketViewsDuplicateView.as_view(), name='api-v1-project-ticket-view-duplicate'),
