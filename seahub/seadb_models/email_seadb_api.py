...
class EmailSeaDBAPI:
    ...
    def get_email_by_pk(self, connection_id, _pk):
        table_name = get_table_name_from_schema('EmailTable', connection_id)
    ...
    def save_reply_email(self, project_uuid, connection_id, thread_id, email_data):
        ...
        email_table_name = get_table_name_from_schema('EmailTable', connection_id)
        thread_table_name = get_table_name_from_schema('ThreadTable', connection_id)

        sender_name = email_data.get('sender_name', '')
        sender_email = email_data['sender_email']

        email_row = {
            get_column_name_from_schema('EmailTable', 'email_from'): formataddr((sender_name, sender_email)) if sender_name else sender_email,
            get_column_name_from_schema('EmailTable', 'email_to'): email_data.get('email_to', ''),
            get_column_name_from_schema('EmailTable', 'title'): email_data.get('subject', ''),
            get_column_name_from_schema('EmailTable', 'cc'): email_data.get('cc') or '',
            get_column_name_from_schema('EmailTable', 'content'): email_data.get('content', ''),
            get_column_name_from_schema('EmailTable', 'text_content'): email_data.get('content', ''),
            get_column_name_from_schema('EmailTable', 'html_content'): email_data.get('html_content') or '',
            get_column_name_from_schema('EmailTable', 'reply_to_message_id'): email_data.get('reply_to_message_id') or '',
            get_column_name_from_schema('EmailTable', 'is_sender'): True,
            get_column_name_from_schema('EmailTable', 'deleted'): False,
            get_column_name_from_schema('EmailTable', 'thread_id'): thread_id,
            get_column_name_from_schema('EmailTable', 'message_id'): email_data.get('message_id') or '',
            get_column_name_from_schema('EmailTable', 'origin_thread_id'): email_data.get('origin_thread_id') or '',
            get_column_name_from_schema('EmailTable', 'email_id'): email_data.get('email_id') or '',
        }
        ...
        self.seadb_api.update_rows(project_uuid, thread_table_name, [{
            'pk': int(thread_id),
            'row': {
                get_column_name_from_schema('ThreadTable', 'modified_time'): now,
                get_column_name_from_schema('ThreadTable', 'record_modified_time'): now,
                get_column_name_from_schema('ThreadTable', 'unread'): False,
            }
        }])
