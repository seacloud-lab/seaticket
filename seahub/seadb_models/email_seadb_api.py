...
class EmailSeaDBAPI:
    ...
    def get_email_by_pk(self, connection_id, _pk):
        table_name = get_table_name('EmailTable', connection_id)
    ...
    def save_reply_email(self, project_uuid, connection_id, thread_id, email_data):
        ...
        email_table_name = get_table_name('EmailTable', connection_id)
        thread_table_name = get_table_name('ThreadTable', connection_id)
