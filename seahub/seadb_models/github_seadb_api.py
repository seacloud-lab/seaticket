...
class GitHubSeaDBAPI:
    ...
    def get_comments_by_issue_id(self, connection_id, issue_id, limit=None):
        table_name = get_table_name_from_schema('GithubIssueCommentsTable', connection_id)
    ...
    def update_issue_record(self, project_uuid, connection_id, record_pk, issue_data):
        ...
        update_row = {
            'pk': int(record_pk),
            'row': {
                get_column_name_from_schema('GithubIssuesTable', 'title'): issue_data.get('title', ''),
                get_column_name_from_schema('GithubIssuesTable', 'labels'): issue_data.get('labels', []),
                get_column_name_from_schema('GithubIssuesTable', 'issue_type'): issue_data.get('issue_type', ''),
                get_column_name_from_schema('GithubIssuesTable', 'state'): issue_data.get('state', ''),
                get_column_name_from_schema('GithubIssuesTable', 'state_reason'): issue_data.get('state_reason', ''),
