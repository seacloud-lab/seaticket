...
WORK_WEIXIN_USER_INFO_AUTO_UPDATE = getattr(settings, 'WORK_WEIXIN_USER_INFO_AUTO_UPDATE', False)
...
#
WORK_WEIXIN_AUTH_CALLBACK_URL = getattr(settings, 'WORK_WEIXIN_AUTH_CALLBACK_URL','')
