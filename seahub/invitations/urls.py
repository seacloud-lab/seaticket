...
from .views import token_view, invitation_link_view, invitation_poster_view
...
urlpatterns = [
    ...
    re_path(r'^poster-link/(?P<token>[a-zA-Z0-9]+)/$', invitation_poster_view, name='invitation_poster_link_view'),
]
