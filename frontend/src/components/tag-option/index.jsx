...
const TagOption = ({ tag = {}, hiddenDescription = true }) => {
  const { color, name, description } = tag;
  return (
    <>
      <div className={classNames('sea-qa-tags-selector-tag-bg mr-2', { 'mt-0': hiddenDescription })} style={{ backgroundColor: color }}></div>
