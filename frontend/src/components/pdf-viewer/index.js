...
import './pdf-file-view.css';

class PDFViewer extends React.Component {

  onDownloadFile = () => {
    location.href = window.app.pageOptions.downloadUrl;
  };
  ...
  renderPDFHead = () => {
    ...
    return (
      <div className="pdfHead d-print-none">
        <div className="dtable-asset-view-head pdf-head-view">
          ...
          <div>
            ...
            <Button color="secondary" id="print" className="dtable-asset-view-print" title={gettext('Print')} aria-label={gettext('Print')}>
              <i className="dtable-font dtable-icon-print" aria-hidden="true"></i>
            </Button>
          </div>
        </div>
      </div>
  ...
  render() {
    const { fileType } = window.app.pageOptions;
    return (
      <React.Fragment>
        {fileType === 'PDF' && this.renderPDFHead()}
        <div id="outerContainer">
            ...
            <div className="toolbar hidden">
              <div id="toolbarContainer">
                <div id="toolbarViewer">
                  ...
                  <div id="toolbarViewerRight" className="hidden">
          ...
          <div id="dialogContainer" className="hidden">
