...
class BindPhone extends React.Component {
  ...
  onSendCode = () => {
    ...
    if (this.validPhone()) {
      ...
      profileSettingsAPI.sendVerifyCode(newPhoneNumber, phoneState).then((res) => {
  ...
  bindPhoneNumber = () => {
    if (this.validPhone() && this.validCode()) {
      ...
      profileSettingsAPI.bindPhoneNumber(newPhoneNumber, inputVerifyCode).then((res) => {
  ...
  unbindPhoneNumber = () => {
    ...
    const enableUnbind = !!(contactEmail);
  ...
  unboundPhoneNumber = () => {
    if (this.validPhone() && this.validCode()) {
      ...
      profileSettingsAPI.unbindPhoneNumber(oldPhoneNumber, inputVerifyCode).then((res) => {
