...
class ConnectionsAPI {
  ...
  markConnectionRecordsOutdated(projectUuid, connectionID, recordIds = []) {
    const url = this.server + '/api/v1/project/' + projectUuid + '/connections/' + connectionID + '/records/mark-outdated/';
    const data = {
