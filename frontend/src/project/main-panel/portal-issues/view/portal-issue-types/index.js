...
const AllPortalIssueTypes = ({ projectUuid, permission }) => {
  ...
  const localStorageName = useMemo(() => `sea-qa-${projectUuid}-portal-issue-types`, [projectUuid]);
...
export default AllPortalIssueTypes;
