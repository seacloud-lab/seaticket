      ...
      <ModalHeader toggle={onClose}>
        <div className="d-flex align-items-center">
          <div className="row-expand-direct-icons mr-2">
            <span
              id="sea-qa-discourse-forums-details-prev-record-btn"
            ...
            <span
              id="sea-qa-discourse-forums-details-next-record-btn"
            ...
            <UncontrolledTooltip
              placement="bottom"
              target="sea-qa-discourse-forums-details-prev-record-btn"
              fade={false}
              trigger="hover"
            ...
            <UncontrolledTooltip
              placement="bottom"
              target="sea-qa-discourse-forums-details-next-record-btn"
              fade={false}
              trigger="hover"
              className="sea-metadata-tooltip"
            >
          ...
          {rowDetails.map(detail => (
            <div key={detail.id} className='sea-qa-discourse-forums-reply-item'>
              <div className='sea-qa-discourse-forums-reply-item-author-info-wrapper'>
                ...
                <div
                  className='sea-qa-discourse-forums-reply-item-author-time'
                  title={formatWithTimezone(detail.updated_at)}
                >
                  {dayjs(detail.updated_at).format('YYYY-MM-DD HH:mm:ss')}
                </div>
              </div>
              <div className='sea-qa-discourse-forums-reply-item-content' dangerouslySetInnerHTML={{ __html: detail.content }} />
            </div>
          ))}
        </div>
      </ModalBody>
