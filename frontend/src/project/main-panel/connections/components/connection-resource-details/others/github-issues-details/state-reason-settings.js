  ...
  return (
    <>
      <div className={classnames('sea-ticket-settings-item mb-4', className)}>
        ...
        <div className={classnames('ticket-types-formatter', { 'valid': option, 'cursor-pointer': !isReadonly && !isSubmitting })} onClick={openEditor} ref={editorRef}>
