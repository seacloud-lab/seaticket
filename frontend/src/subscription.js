...
class UserSubscription extends React.Component {
  ...
  constructor(props) {
    ...
    this.sideNavItems = [
      ...
      { show: true, href: '#row-limit', text: '行数限制' },
      { show: true, href: '#asset-quota', text: '附件空间' },
      { show: true, href: '#current-subscription-period', text: '订阅有效期' },
      { show: true, href: '#hold-coins', text: '代金币' },
  ...
  render() {
    ...
    return (
      <div className="dtable-web-subscription h-100 d-flex flex-column">
