...
class DeadlineDate extends React.Component {
  ...
  componentDidMount() {
    ...
    let date = new Date(this.state.textValue);
    if (date instanceof Date && !isNaN(date.getTime())) {
      let newValue = this.collectionatDate(date);
  ...
  onSave = () => {
    ...
    value = this.collectionatDate(date);
  ...
  render() {
    ...
    return (
      <div className="setting-item table-setting form-setting-remarks">
        <DTableSwitch
          checked={checked}
...
DeadlineDate.propTypes = propTypes;
