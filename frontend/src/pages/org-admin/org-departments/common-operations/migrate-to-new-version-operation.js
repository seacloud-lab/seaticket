...
class MigrateToNewVersionOperation extends React.Component {
  ...
  handleSubmit = () => {
    ...
    orgAdminServiceApi.orgAdminListAddressBookV2Departments(orgID, -1).then(res => {
      ...
      orgAdminServiceApi.orgAdminAddressBookV2DepartmentsMigrate(orgID).then(() => {
  ...
  render() {
    ...
    const { isDialogShow, isMigrating } = this.state;
