...
class Item extends Component {
  ...
  getOperationDetail = (item) => {
    ...
    let detailText = '';
    let groupPageUrl = siteRoot + 'org/groupadmin/' + detail.id + '/';
  ...
  render() {
    ...
    return (
      <tr onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut}>
        <td>
          <a href={siteRoot + 'org/useradmin/info/' + item.username + '/'} className="font-weight-normal">{item.name}</a>
        </td>
...
class AuditLogs extends Component {
  ...
  getLogsByPage = (page) => {
    ...
    orgAdminServiceApi.orgAdminListAuditLogs(orgID, page, perPage).then((res) => {
      this.setState({
