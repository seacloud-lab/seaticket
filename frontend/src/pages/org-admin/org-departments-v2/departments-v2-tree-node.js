        ...
        >
          {this.state.isShowTreeIcon ?
            <span className="departments-v2-tree-icon" onClick={(e) => this.toggleChildren(e)}>
              <i className={`dtable-font dtable-icon-down3 ${isChildrenShow ? '' : 'rotate-270'}`}></i>
            </span>
            :
          ...
          {active && node.id !== 'other_users' &&
            ...
            >
              ...
              >
                <i className="dtable-font dtable-icon-more-vertical"></i>
              </DropdownToggle>
              <DropdownMenu
                ...
                {node.id !== -1 && (
                  <Fragment>
                    ...
                    <DropdownItem
                      ...
                      disabled={true}
                    >
                      {`${gettext('Department ID')} : ${node.idInOrg}`}
                    </DropdownItem>
                  </Fragment>
                )}
              </DropdownMenu>
