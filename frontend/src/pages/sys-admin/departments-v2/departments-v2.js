...
class DepartmentsV2 extends React.Component {
  ...
  loadDepartmentMembers = (nodeId) => {
    ...
    if (nodeId === 'other_users') {
      sysAdminServiceApi.sysAdminListAddressBookV2NonDepartmentUsers().then(res => {
      ...
      sysAdminServiceApi.sysAdminListAddressBookV2DepartmentMembers(nodeId).then(res => {
  ...
  listSubDepartments = (nodeId, cb) => {
    ...
    sysAdminServiceApi.sysAdminListAddressBookV2Departments(nodeId).then(res => {
  ...
  getGroup = (nodeId, cb) => {
    sysAdminServiceApi.sysAdminGetAddressBookV2DepartmentGroup(nodeId).then(res => {
      cb && cb(res.data);
    }).catch(error => {
  ...
  deleteGroup = (nodeId, cb) => {
    sysAdminServiceApi.sysAdminDeleteAddressBookV2DepartmentGroup(nodeId).then(() => {
  ...
  createGroup = (nodeId, cb) => {
    sysAdminServiceApi.sysAdminCreateAddressBookV2DepartmentGroup(nodeId).then(res => {
      cb && cb(res.data);
    }).catch(error => {
      let errMessage = Utils.getErrorMsg(error);
      toaster.danger(errMessage);
  ...
  onDelete = () => {
    ...
    sysAdminServiceApi.sysAdminDeleteAddressBookV2Department(operateNode.id).then(() => {
  ...
  setMemberStaff = (email, isStaff) => {
    ...
    sysAdminServiceApi.sysAdminUpdateAddressBookV2DepartmentMember(checkedDepartmentId, email, { is_staff: isStaff }).then(res => {
  ...
  deleteMember = (email) => {
    const { checkedDepartmentId, membersList } = this.state;
    sysAdminServiceApi.sysAdminDeleteAddressBookV2DepartmentMember(checkedDepartmentId, email).then(() => {
