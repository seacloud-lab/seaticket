...
class ExternalLinks extends Component {
  ...
  getExternalLinkListByPage = (page) => {
    sysAdminServiceApi.sysAdminListExternalLinks(page, this.state.perPage).then((res) => {
      this.setState({
        loading: false,
  ...
  searchItems = (keyword) => {
    navigate(`${siteRoot}sys/search-external-links/?query=${encodeURIComponent(keyword)}`);
  };
      ...
      <Fragment>
        ...
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            <ExternalLinkNav currentItem="external-links" />
