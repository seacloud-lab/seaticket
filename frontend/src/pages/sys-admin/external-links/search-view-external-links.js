...
class Item extends Component {
  ...
  deleteExternalLink = () => {
    sysAdminServiceApi.sysAdminDeleteViewExternalLink(this.props.item.token).then(() => {
...
class SearchViewExternalLinks extends Component {
  ...
  getItems = (page) => {
    sysAdminServiceApi.sysAdminSearchViewExternalLinks(this.state.query.trim(), page, this.state.perPage).then(res => {
      this.setState({
      ...
      <Fragment>
        ...
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            <h2 className="heading">{gettext('View external links')}</h2>
            <div className="cur-view-content">
              <div className="mt-4 mb-6">
                <h4 className="border-bottom font-weight-normal mb-2 pb-1">{gettext('Search view external links')}</h4>
                <Form>
                  <FormGroup row>
                    <Col sm={5}>
...
SearchViewExternalLinks.propTypes = propTypes;

export default SearchViewExternalLinks;
