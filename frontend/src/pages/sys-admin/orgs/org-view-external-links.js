...
class OrgViewExternalLinks extends Component {
  ...
  getExternalLinkListByPage = (page) => {
    sysAdminServiceApi.sysAdminListViewExternalLinks(page, this.state.perPage, { orgID: this.props.orgID }).then((res) => {
      this.setState({
        loading: false,
      ...
      <Fragment>
        ...
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            <OrgNav
              currentItem="view-external-links"
...
OrgViewExternalLinks.propTypes = ExternalLinksPropTypes;
