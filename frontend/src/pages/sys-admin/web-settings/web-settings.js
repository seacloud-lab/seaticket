        ...
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            ...
            <div className="cur-view-content container mw-100 px-4">
              ...
              <Fragment>
                <p className="tip-default my-4">{gettext('Note: Settings via web interface are saved in database table (sea-qa-db/constance_config). They have a higher priority over the settings in config files.')}</p>
