...
const SFTableSearcherInput = ({ rowsCount, columnsCount, setHasSearchValue, searchCells, onKeyDown }) => {
  ...
  const getSearchDelayTime = () => {
    const viewCellsCount = (rowsCount || 0) * (columnsCount || 0);
  ...
  return (
    <input
      className="form-control sea-qa-search-input"
      type="text"
      autoFocus
      value={searchValue}
