...
import { getNumberDisplayString } from '../../utils/column';
...
const NumberFormatter = ({ value, formats, className, children: emptyFormatter }) => {
  ...
  return (
    <div
      className={classnames('sea-metadata-ui cell-formatter-container text-formatter number-formatter', className)}
      title={validValue}
    >
      {validValue}
    </div>
