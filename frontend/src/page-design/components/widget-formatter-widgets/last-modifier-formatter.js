...
import { LastModifierFormatter } from 'dtable-ui-component';

const { mediaUrl } = window.app.config;

class CustomLastModifierFormatter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isDataLoaded: false,
  ...
  render() {
    ...
    return (
      <LastModifierFormatter collaborators={[collaborator]} value={cellValue} containerClassName={containerClassName} />
    );
  }
}

CustomLastModifierFormatter.propTypes = {
  cellValue: PropTypes.string,
  collaborators: PropTypes.array,
  containerClassName: PropTypes.string,
};

export default CustomLastModifierFormatter;
