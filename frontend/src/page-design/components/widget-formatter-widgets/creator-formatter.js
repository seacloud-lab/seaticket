...
class CustomCreatorFormatter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isDataLoaded: false,
  ...
  render() {
    ...
    return (
      <CreatorFormatter collaborators={[collaborator]} value={cellValue} containerClassName={containerClassName} />
    );
  }
}

CustomCreatorFormatter.propTypes = {
  cellValue: PropTypes.string,
  collaborators: PropTypes.array,
  containerClassName: PropTypes.string,
};

export default CustomCreatorFormatter;
