...
import { Modal, ModalBody, ModalFooter, Button, Alert,
...
class AddParticipantsFieldDialog extends Component {
        ...
        <ModalBody className="add-state-field-container">
          ...
          <FormGroup>
            ...
            <div className="form-control add-state-field-type-content">
              ...
              <span>{gettext('Collaborator')}</span>
            </div>
          </FormGroup>
...
AddParticipantsFieldDialog.propTypes = {
  table: PropTypes.object,
  onToggle: PropTypes.func.isRequired,
  onSubmit: PropTypes.func.isRequired,
};

export default AddParticipantsFieldDialog;
